...
This module provides methods for executing commands in subprocesses.
"""
# Standard Libraries
import os
import subprocess
...
def exec_cmd(
    ...
    **kwargs,
    ...
    Args:
        ...
        stream_output: if true, does not capture standard output and error; if false, captrues these
